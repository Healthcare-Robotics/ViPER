...
from prediction.model.fpn_bottleneck_logits_model import BottleneckClassifierModel
from prediction.model.fpn_bottleneck_logits_model import BottleneckRegressionModel


class FPN_DANN_Logits_Regression(torch.nn.Module):
    ...
    def __init__(
        ...
        self.regression_head = SegmentationHead(
            in_channels=self.decoder.out_channels,
            out_channels=1,
            activation=activation,
            kernel_size=1,
        ...
        self.bottleneck_logits_model = BottleneckRegressionModel(num_out_logits=num_out_logits)
    ...
    def initialize_weights(self):
        ...
        self.initialize_head(self.regression_head)
    ...
    def forward(self, x, alpha=1):
        ...
        # masks = self.segmentation_head(decoder_output) # For classification TODO: move regression to new file
        masks = self.regression_head(decoder_output)
