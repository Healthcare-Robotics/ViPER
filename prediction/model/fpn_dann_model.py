...
from prediction.model.feats_to_logits import get_dann_model


class FPN_DANN(torch.nn.Module):
    ...
    def forward(self, x, alpha=1):
        ...
        bottleneck_logits = self.domain_classifier_model(reverse_feature)
