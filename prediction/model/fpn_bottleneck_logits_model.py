...
from prediction.model.feats_to_logits import BottleneckClassifierModel
from prediction.model.feats_to_logits import BottleneckRegressionModel


class FPNBottleneckLogits(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        bottleneck_logits = self.bottleneck_logits_model(features)

        return masks, bottleneck_logits
